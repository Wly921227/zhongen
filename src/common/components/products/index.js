...
let list = [
    {
        id: 0, img: require('images/niu.png'), title: '乳炎净饲用（饲料添加剂）', path: 'niu',
        desc: [
    ...
    {
        id: 1, img: require('images/zhu.png'), title: '猪痢净饲用（饲料添加剂）', path: 'zhu',
        desc: [
    ...
    {
        id: 3, img: require('images/ji.png'), title: '鸡瘟毒清饲用（饲料添加剂）', path: 'ji',
        desc: [
    ...
    {
        id: 4, img: require('images/ya.png'), title: '鹅鸭毒清饲用（饲料添加剂）', path: 'ya',
        desc: [
